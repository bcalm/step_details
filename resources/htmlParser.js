...
const head = `<head>
  ...
  <link href="styles/sukhdevIndex.css" rel="stylesheet" type="text/css">
  </head>`;
...
writeFileSync("./styles/sukhdevIndex.css", styles, "utf8");
writeFileSync("./sukhdevIndex.html", html, "utf8");